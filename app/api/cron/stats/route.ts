...
const STAT_PAGES: { id: string; key: string; pctField?: boolean }[] = [
  ...
  { id: '227', key: 'clearPct', pctField: true },
  { id: '234', key: 'turnoversPerGame' },
  { id: '233', key: 'causedTurnoversPerGame' },
  { id: '209', key: 'savePct', pctField: true },
  { id: '564', key: 'oppShotPct', pctField: true },
];
  ...
  try {
    ...
    const teams = Object.entries(allStats)
      ...
      .map(([name, stats]) => ({
        ...
        oppShotPct: stats.oppShotPct ?? 0.28,
    ...
    return NextResponse.json({ success: true, teamsCount: teams.length, updatedAt: new Date().toISOString() });
  } catch (error: any) {
